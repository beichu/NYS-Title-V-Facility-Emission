---
title: "Data-Driven Exploration of Title V Facility Emissions in New York"
...
table1 <- emission_data_clean %>%
    ...
    kable(table1, caption = "Top Industries in New York Based on the Number of Title V Facilities", align = "l", 
          escape = F, format = "html", booktabs = T) %>%
...
Carbon Dioxide (CO~2~) stands out with the highest cumulative emissions of 603,630,580 tons statewide. CO~2~ also has the highest median annual value of 12,965 tons, indicating that CO~2~ is a ubiquitous byproduct of industrial activities involving combustion.
